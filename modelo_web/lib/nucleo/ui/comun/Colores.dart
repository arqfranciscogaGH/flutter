...
final _listaMaterialColores = <String, dynamic>{
...
final _listaColoresPersonalizado = <String, dynamic>{
...
class Colores
{
    static Map<int, Color> listaColoresTemp =
    {
    ...
    {
        MaterialColor colorPersonalizado = MaterialColor(50, listaColoresTemp);
...
//     } 
   static Color obtenerColor(String  color)
  {
      ...
      if (color!=null && color!="")
          matcolor =  _listaColoresPersonalizado[color];
 ...
 static Color obtenerColorIndex(int  indexColor)
    {
        ...
        if (indexColor!=null )
           indexColor=0;
        color = _listaColoresPersonalizado.values.elementAt(indexColor);
