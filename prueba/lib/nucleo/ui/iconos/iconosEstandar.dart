...
//  librerias  proyecto
 ...
 final _listaIconosEstandar = <String, IconData>{
      'house'                     : Icons.house  ,  
      'login'                     : Icons.login  ,   
...
class IconosEstandar
{
  static Icon crear(  String nombre , [ String, tipo="", dynamic color ,  double tamano=12 ]  ) {
     ...
     if (  tamano==null || tamano==0  )
        tamano=12;
     IconData? icono=_listaIconosEstandar[nombre];
