...
class AccesoApi extends IAccesoBD {
  ...
  @override
  Future<Map<String, dynamic>> obtener(String nombreTabla, Map<String, dynamic> map, String campo, int id) async {
  ...
  Future<Map<String, dynamic>> insertar(
    ...
    if (respuesta.statusCode == 200 ||  respuesta.statusCode ==  201) // cuando  se presenta error es  el codigo 400,404 409
      listaMap = json.decode(respuesta.body);
   return listaMap!;
  }
  ...
  Future<dynamic> actualizar(String nombreTabla, Map<String, dynamic> map, String campo, int id) async {
    ...
    print(respuesta.statusCode);
    if (respuesta.statusCode != 204) // cuando  se presenta error el codigo 400,404 409
      map = listaMap!;
    return map;
  }
