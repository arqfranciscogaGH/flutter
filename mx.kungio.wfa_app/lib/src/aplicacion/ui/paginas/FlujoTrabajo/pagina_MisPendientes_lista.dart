...
class pagina_MisPendientes_lista extends StatefulWidget {
  pagina_MisPendientes_lista(
      {Key key,
      this.titulo,
      this.pagina,
      ...
      : super(key: key);
  String titulo;
  String pagina = "pagina_MisPendientes_lista";
  String paginaSiguiente = "";
  String paginaAnterior = "";
  String accionPagina = ""; // avanzar, regresar
  bool activarAcciones = false;
  static String ruta = "pagina_MisPendientes_lista";

  @override
  _pagina_MisPendientes_lista createState() => _pagina_MisPendientes_lista();
}

class _pagina_MisPendientes_lista extends State<pagina_MisPendientes_lista> {
  ...
  void initState() {
    ...
    provider.limpiar();
    // provider.asignarParametros("FTConsulta/LINEAIV/''/1/ConsultarMisPendientes/", "prueba");
  ...
  Widget mostrarContenido() {
    ...
    return Consumer<MisPendientesControlador>(
