...
import '../../../negocio/controlador/FTActividadInfoControlador.dart';
export '../../../negocio/controlador/FTActividadInfoControlador.dart';

import '../../../negocio/controlador/EstadisticasFlujoControlador.dart';
export '../../../negocio/controlador/EstadisticasFlujoControlador.dart';

class ActividadInfoUI {
  ActividadInfoUI({this.provider, this.idioma});
  ...
  Widget crearElementoEntidad(
    ...
    elemento.subitulo ="Importe: " +entidad.importe.toString() ;
