...
class UsuarioUI {
  ...
  obtenerIdSuscriptor()
  {
      ...
      if  (providerSuscripcion.entidad!=null  && providerSuscripcion.entidad.id!=0  )
  ...
  Widget crearElementoEntidad(
    ...
    elemento.subitulo=entidad.cuenta;
  ...
  void guardarEntidad(BuildContext context, ElementoLista elemento) {
    ...
    if (entidadCaptura.id == null || entidadCaptura.id == 0) {
        ...
        provider.insertarEntidad(context, elemento, entidadCaptura, elemento.callBackAccion);
    } else {
         provider.modificarEntidad(context, elemento, entidadCaptura, elemento.callBackAccion2);
    }
