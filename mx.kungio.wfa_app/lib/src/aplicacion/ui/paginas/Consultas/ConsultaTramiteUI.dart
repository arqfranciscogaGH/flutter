...
import '../../../negocio/controlador/ConsultaTramiteControlador.dart';
export '../../../negocio/controlador/ConsultaTramiteControlador.dart';





class ConsultaTramiteUI {
  ConsultaTramiteUI({this.provider, this.idioma});
