...
class ProductividadDetalle extends EntidadBase {
  //    variables
  //    propiedades
  ...
  ProductividadDetalle({
    ...
    this.grupo,
            ...
            tabla: "ProductividadDetalle");
  //    métodos

  factory ProductividadDetalle.fromMap(Map<String, dynamic> map) => new ProductividadDetalle(
        id: map["id"],
        llave: map["llave"],
        clave: map["clave"],
        nombre: map["nombre"],
  ...
  ProductividadDetalle fromMap(Map<String, dynamic> map) => new ProductividadDetalle(
         id: map["id"],
        llave: map["llave"],
        clave: map["clave"],
        nombre: map["nombre"],
  ...
  ProductividadDetalle iniciar() {
    ProductividadDetalle entidad = ProductividadDetalle();
    entidad.id = 0;
    entidad.llave = "";
    entidad.clave = "";
    entidad.nombre = "";
  ...
  ProductividadDetalle fromJson(String cadenaJson) =>
      this.fromMap(json.decode(cadenaJson));

  Map<String, dynamic> fromJsonToMap(String cadenaJson) =>
      json.decode(cadenaJson);

  List<ProductividadDetalle> mapTolista(List<dynamic> listaMapa) {
    List<ProductividadDetalle> lista = listaMapa.isNotEmpty
        ? listaMapa.map((c) => this.fromMap(c)).toList()
        : [];
    return lista;
  }

  List<ProductividadDetalle> jsonToList(String cadenaJson) {
    List<dynamic> listaMap = json.decode(cadenaJson);
    List<ProductividadDetalle> lista = mapTolista(listaMap);
    return lista;
  }
}
