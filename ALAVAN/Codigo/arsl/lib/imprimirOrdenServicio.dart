...
class imprimirOrdenServicio extends StatefulWidget {
  final List<Map<String, dynamic>> data;
  imprimirOrdenServicio(this.data);
  @override
  _imprimirOrdenServicio createState() => _imprimirOrdenServicio();
}

class _imprimirOrdenServicio extends State<imprimirOrdenServicio> {
    ...
    if (Platform.isAndroid) {
      bluetoothManager.state.listen((val) {
        ...
        if (val == 12) {
          ...
          print('off');
          setState(() => _devicesMsg = 'No hay conexion con Blutooth, Active el Blutooth por favor!');
        }
      });
    } else {
      initPrinter();
  ...
  void initPrinter() {
    ...
    _printerManager.scanResults.listen((val) {
      ...
      if (_devices.isEmpty) setState(() => _devicesMsg = 'No hay impresoras, conecte la impresora por favor!');
    });
  }
